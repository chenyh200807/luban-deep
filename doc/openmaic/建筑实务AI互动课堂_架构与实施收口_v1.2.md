...
> 状态：**canonical**
>
> 自 2026-04-22 起，本文件是 `doc/openmaic/` 下关于建筑实务 AI 互动课堂的**唯一收口文档**，负责解决 v1.0 / v1.1 文档之间的 authority、transport、状态机、对象命名和 MVP 边界漂移。
>
> 若本文件与以下文档冲突，以本文件为准：
>
...
> 配套文件：
>
> - [README.md](/Users/yehongchen/Documents/CYH_2/Markzuo/deeptutor/doc/openmaic/README.md)
...
### Phase B: Generation And Playback
