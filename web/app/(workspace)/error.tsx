  ...
  return (
    <div className="flex h-full items-center justify-center bg-[var(--background)] px-6 text-[var(--foreground)]">
      <div className="w-full max-w-lg rounded-3xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-[0_16px_48px_rgba(0,0,0,0.08)]">
        <p className="text-sm font-medium text-[var(--muted-foreground)]">{t("Workspace load failed")}</p>
        <h1 className="mt-2 text-2xl font-semibold tracking-tight">{t("Unable to render this page")}</h1>
        <p className="mt-3 text-sm leading-6 text-[var(--muted-foreground)]">
          {t("This is usually a local rendering error. Retry this route first; if it persists, refresh the page.")}
        </p>
