      ...
      <body className="bg-[var(--background)] text-[var(--foreground)]">
        <div className="flex min-h-screen items-center justify-center px-6 py-12">
          <div className="w-full max-w-md rounded-3xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
            <p className="text-sm font-medium text-[var(--muted-foreground)]">{t("Application error")}</p>
            <h1 className="mt-2 text-2xl font-semibold tracking-tight">{t("This page is temporarily unavailable")}</h1>
            <p className="mt-3 text-sm leading-6 text-[var(--muted-foreground)]">
              {t("This is usually temporary. Retry first; if it persists, refresh the page.")}
            </p>
