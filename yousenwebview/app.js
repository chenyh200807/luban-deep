...
const USE_LOCAL_DEVTOOLS =
  typeof __USE_LOCAL_DEVTOOLS__ !== "undefined" ? __USE_LOCAL_DEVTOOLS__ : true; // M24 local manual test: devtools+develop -> http://127.0.0.1:8001 (revert to false after testing)
