...
assert(
  ...
  "package chat home should render backend today_focus and pass prompt intent without deriving training truth",
);
assert(
  ...
  "package today focus card should surface a short user-facing reason with consistent yellow typography",
);
assert(
