...
def _classify(has_auth: bool, has_rate: bool) -> str:
    if has_auth:
            ...
            endpoints.append(
                {
                    ...
                    "is_public_marker": False,  # PR-1a will populate this from public_manifest
                    "classification": _classify(has_auth, has_rate),
                }
            )
