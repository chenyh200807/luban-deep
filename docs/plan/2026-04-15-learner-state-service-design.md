...
- 文档路径：`/docs/plan/2026-04-15-learner-state-service-design.md`
- 创建日期：2026-04-15
- 适用范围：TutorBot、Guide、Notebook、Quiz、Review、Heartbeat、Session Writeback、Profile/Progress/Summary
- 状态：Implemented foundation v1（服务基础已实现；产品闭环仍看主 PRD gate）
- 关联文档：
...
- 服务入口：`deeptutor/services/learner_state/service.py`
- Supabase core store：`deeptutor/services/learner_state/supabase_store.py`
- Supabase outbox writer：`deeptutor/services/learner_state/supabase_writer.py`
- Runtime：`deeptutor/services/learner_state/runtime.py`
- Heartbeat：`deeptutor/services/learner_state/heartbeat/`
- 运营面：`deeptutor/services/member_console/service.py`
