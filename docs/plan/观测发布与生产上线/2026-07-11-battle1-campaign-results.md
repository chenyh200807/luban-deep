...
**完成分支复测(2026-07-12,+W2-T3 批量落库,commit 0321a76b)**:

| 并发 | 完成分支 events/s | vs OLD | vs 已部署 |
|---|---|---|---|
| 8 | 4750 | 1.8× | -15%(低并发 flush 窗代价,两版此档均远超真实负载;传输 fan-out 即时不受影响) |
| 32 | 8356 (53.9 turns/s) | **3.0×** | +52% |
| 64 | 8448 (54.5 turns/s) | **3.1×** | +62% |
