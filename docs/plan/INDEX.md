...
| [2026-05-13-luban-case-grading-error-map-prd.md](2026-05-13-luban-case-grading-error-map-prd.md) | PRD | Proposed v1.1 | 建筑实务案例题 AI 阅卷、Rubric 投影、错因图谱、个性化变式训练；明确复用 Supabase `questions_bank`、assessment、learner state、deep_question 基础，不新建第二套题库。 |
| [2026-05-13-luban-case-grading-error-map-implementation-plan.md](2026-05-13-luban-case-grading-error-map-implementation-plan.md) | Implementation Plan | Draft v1 | 将案例题 AI 阅卷 PRD 拆成 P0/P1 可执行任务：readiness audit、`case_grading` 内核、learner writeback、题库优先推荐、`deep_question` 接入和验证 gate。 |
