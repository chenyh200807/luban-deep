...
| [2026-05-25-luban-assessment-testset-p0b-p1-production-flywheel-execution-plan.md](2026-05-25-luban-assessment-testset-p0b-p1-production-flywheel-execution-plan.md) | Execution Plan | Pilot-ready after automated gates; manual signoffs remain | 接 Assessment TestSet PRD 与 P0A execution plan，将 P0A 扩成 P0B/P1 production flywheel：10 专题 catalog、3/5 form-bank gate、`assessment_forms` RLS service-role-only、个性化推荐、错题 3 题训练闭环、20 题真题样式 mini simulation、P1 post-submit static explanation projection 和 production/DevTools gates；2026-05-26 completion sweep 补 service-role provider guard、real-exam source-policy smoke guard、deep explanation cost/circuit breaker gate 和前端 copy 收口。QA 见 [train0-storage-security](../qa/2026-05-25-assessment-testset-train0-storage-security-probe.md) / [topic-catalog-audit](../qa/2026-05-25-assessment-testset-topic-catalog-form-bank-audit.md) / [flywheel-dry-run](../qa/2026-05-25-assessment-testset-p0b-p1-flywheel-dry-run.md)。 |
