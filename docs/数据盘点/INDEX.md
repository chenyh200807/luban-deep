...
| 产物 | 状态 |
|---|---|
| `2025_jianzhu_case_rubric.jsonl`(80 采分点) | ✅ 首份验证完成;待复核转录 + 回填 per_question |
| 2024/2023/2021/2022/2022补考 | ⏳ 待抽(2021/2022 先验版式) |

## 待办盘点(下次补)

- [ ] 抽 2024/2023/2021/2022/2022补考(套抽取协议;2021/2022 先验版式)+ 复核 2025 转录
- [ ] 抽取结果回填 `per_question_grading_object` 的 `score:null`(标 authority=yousen)+ 写入封顶判分规则
...
- [ ] 核 2025 案例 sub_q 总分结构(为何案例四/五 Σ>20——踩点制 or 分值结构)
