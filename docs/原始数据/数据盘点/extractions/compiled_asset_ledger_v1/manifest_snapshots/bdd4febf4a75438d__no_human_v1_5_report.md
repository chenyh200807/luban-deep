...
- samples: `100`
- point_labels: `485`
- deterministic_point_labels: `369`
- deterministic_ratio: `0.7608`
- residual_counts: `{"boundary": 116}`
- resolution_counts: `{"A": 369, "B": 116}`
- po_workload_ratio: `0.2392`
- external_expert_necessity_ratio: `0.0`
- R7a_PO_self_decision_queue: `116`
...
- anchor_source_counts: `{"calculation": 15, "exam_figure": 3, "non_textbook": 4, "official_answer_weak": 18, "textbook": 57}`
- textbook_anchor_point_ratio: `0.5876`

## v0 vs v1.5 Deterministic Subset

| arm | samples | mean abs delta v1.5 | mean abs delta v0 same subset |
|---|---:|---:|---:|
| artifact_first | 100 | 0.8934 | 1.1598 |
| baseline | 100 | 2.6885 | 2.9539 |
| rag | 100 | 2.6885 | 2.9539 |
