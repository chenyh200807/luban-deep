...
- samples: `100`
- point_labels: `485`
- deterministic_point_labels: `469`
- deterministic_ratio: `0.967`
- residual_counts: `{"boundary": 16}`
- resolution_counts: `{"A": 469, "B": 16}`
- po_workload_ratio: `0.033`
- external_expert_necessity_ratio: `0.0`
- R7a_PO_self_decision_queue: `16`
- R7b_external_expert_last_resort_queue: `0`
- unanchored_root_cause_counts: `{"genuinely_absent": 19, "rubric_is_paraphrase": 28, "junk_non_term": 5, "label_subterms_anchored_to_official_sources": 13}`
...
|---|---:|---:|---:|
| artifact_first | 100 | 1.1536 | 1.7671 |
| baseline | 100 | 3.2556 | 3.9321 |
| rag | 100 | 3.2556 | 3.9321 |
