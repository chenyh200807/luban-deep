...
- samples: `100`
- point_labels: `485`
- deterministic_point_labels: `429`
- deterministic_ratio: `0.8845`
- residual_counts: `{"boundary": 56}`
- resolution_counts: `{"A": 429, "B": 56}`
- po_workload_ratio: `0.1155`
- external_expert_necessity_ratio: `0.0`
- R7a_PO_self_decision_queue: `56`
...
- anchor_source_counts: `{"calculation": 17, "exam_figure": 3, "non_textbook": 4, "official_answer_weak": 4, "textbook": 69}`
- textbook_anchor_point_ratio: `0.7113`

## v0 vs v1.5 Deterministic Subset

| arm | samples | mean abs delta v1.5 | mean abs delta v0 same subset |
|---|---:|---:|---:|
| artifact_first | 100 | 1.5253 | 1.5968 |
| baseline | 100 | 3.2936 | 3.5471 |
| rag | 100 | 3.2936 | 3.5471 |
