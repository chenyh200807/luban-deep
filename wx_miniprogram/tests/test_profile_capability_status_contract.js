// test_profile_capability_status_contract.js — unavailable advanced abilities must be explicit
...
assert(/capabilityItems:\s*\[/.test(profileJs), "profile should declare capability availability items");
