...
(async function () {
  ...
  assert(
    ...
    "history should migrate legacy array tombstones and still filter deleted conversations",
  );
  assert(
    ...
    "legacy array tombstones should be rewritten into the canonical object map",
  );
