...
assert(
  reportWxml.indexOf("<view class=\"insight-strip glass-card\" wx:if=\"{{reportDetailView == 'home' && focusHint}}\">") >= 0,
...
assertIncludes(reportSource, 'this.data.reportDetailView !== "map"', "report should only render radar canvas inside the mastery map detail view");
