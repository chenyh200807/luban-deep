// test_chat_copy_authority.js — copy button should use visible user-facing content
// Run: node wx_miniprogram/tests/test_chat_copy_authority.js
...
console.log("PASS test_chat_copy_authority.js (" + pass + " assertions)");
