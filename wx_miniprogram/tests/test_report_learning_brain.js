...
async function run() {
  ...
  assert(
    ...
    "report page must route chapter taxonomy through the shared utils/taxonomy authority — must NOT expose raw chapter codes or collapse them into the meaningless 综合能力 label",
  );
  assert(
