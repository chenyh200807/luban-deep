...
def _message_accepts_next_training_for_stored_set(
    ...
    """True when an action-only reply accepts the stored graded question's next
    training step. This is the same "turn references the active object" shape as the
    ordinal / re-present / submission demote carve-outs; the business evidence is the
    stored graded question context, not the bare token itself.
    """
