...
BI_METRICS: tuple[BIMetricDefinition, ...] = (
    ...
    # 学习模块偏好驾驶舱（2026-07-21，学习模块偏好计划 §4/§6）。
    # 单一 authority=product_behavior_store.get_engagement_breakdown。学习模块当前流量极低,
    # 小样本统计噪声大 → 全组钉 C 级,看板须同步标灰可信度徽标,禁据此自动决策。
    BIMetricDefinition(
